...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=11.9cm]{TypicalPlotDelay=NORMALInit=FalseDup=IBRC.pdf}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=11.9cm]{TypicalPlotDelay=DIFFInit=TrueDup=IBRC.pdf}
